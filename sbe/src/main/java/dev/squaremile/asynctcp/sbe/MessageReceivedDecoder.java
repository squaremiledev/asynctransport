...
public class MessageReceivedDecoder
{
    ...
    private final MessageReceivedDecoder parentMessage = this;
    ...
    public MessageReceivedDecoder wrap(
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[MessageReceived](sbeTemplateId=");
