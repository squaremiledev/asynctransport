...
public class TransportCommandFailedEncoder
{
    ...
    private final TransportCommandFailedEncoder parentMessage = this;
    ...
    public TransportCommandFailedEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public TransportCommandFailedEncoder wrapAndApplyHeader(
    ...
    public TransportCommandFailedEncoder port(final int value)
    {
    ...
    public TransportCommandFailedEncoder commandId(final long value)
    {
    ...
    {
        TransportCommandFailedDecoder writer = new TransportCommandFailedDecoder();
