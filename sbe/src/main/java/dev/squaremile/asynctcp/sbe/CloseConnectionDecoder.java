...
public class CloseConnectionDecoder
{
    ...
    private final CloseConnectionDecoder parentMessage = this;
    ...
    public CloseConnectionDecoder wrap(
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[CloseConnection](sbeTemplateId=");
