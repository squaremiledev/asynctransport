...
public class SendDataEncoder
{
    ...
    private final SendDataEncoder parentMessage = this;
    ...
    public SendDataEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public SendDataEncoder wrapAndApplyHeader(
    ...
    public SendDataEncoder port(final int value)
    {
    ...
    public SendDataEncoder connectionId(final long value)
    {
    ...
    public SendDataEncoder commandId(final long value)
    {
    ...
    public SendDataEncoder capacity(final int value)
    {
    ...
    {
        SendDataDecoder writer = new SendDataDecoder();
