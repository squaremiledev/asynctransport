...
public class ConnectionResetByPeerDecoder
{
    ...
    private final ConnectionResetByPeerDecoder parentMessage = this;
    ...
    public ConnectionResetByPeerDecoder wrap(
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[ConnectionResetByPeer](sbeTemplateId=");
