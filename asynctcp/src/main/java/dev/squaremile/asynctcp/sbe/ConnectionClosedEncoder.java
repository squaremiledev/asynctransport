...
public class ConnectionClosedEncoder
{
    ...
    private final ConnectionClosedEncoder parentMessage = this;
    ...
    public ConnectionClosedEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public ConnectionClosedEncoder wrapAndApplyHeader(
    ...
    public ConnectionClosedEncoder port(final int value)
    {
    ...
    public ConnectionClosedEncoder commandId(final long value)
    {
    ...
    public ConnectionClosedEncoder connectionId(final long value)
    {
    ...
    {
        ConnectionClosedDecoder writer = new ConnectionClosedDecoder();
