...
import static dev.squaremile.asynctcp.domain.connection.ConnectionState.DATA_TO_SEND_BUFFERED;
import static dev.squaremile.asynctcp.domain.connection.ConnectionState.NO_OUTSTANDING_DATA;
