...
public class StoppedListeningEncoder
{
    ...
    private final StoppedListeningEncoder parentMessage = this;
    ...
    public StoppedListeningEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public StoppedListeningEncoder wrapAndApplyHeader(
    ...
    public StoppedListeningEncoder port(final int value)
    {
    ...
    public StoppedListeningEncoder commandId(final long value)
    {
    ...
    {
        StoppedListeningDecoder writer = new StoppedListeningDecoder();
