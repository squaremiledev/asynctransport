...
public class CloseConnectionEncoder
{
    ...
    private final CloseConnectionEncoder parentMessage = this;
    ...
    public CloseConnectionEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public CloseConnectionEncoder wrapAndApplyHeader(
    ...
    public CloseConnectionEncoder port(final int value)
    {
    ...
    public CloseConnectionEncoder connectionId(final long value)
    {
    ...
    public CloseConnectionEncoder commandId(final long value)
    {
    ...
    {
        CloseConnectionDecoder writer = new CloseConnectionDecoder();
