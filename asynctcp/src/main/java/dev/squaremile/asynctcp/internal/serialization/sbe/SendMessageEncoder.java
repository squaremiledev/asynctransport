...
public class SendMessageEncoder
{
    ...
    private final SendMessageEncoder parentMessage = this;
    ...
    public SendMessageEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public SendMessageEncoder wrapAndApplyHeader(
    ...
    public SendMessageEncoder port(final int value)
    {
    ...
    public SendMessageEncoder connectionId(final long value)
    {
    ...
    public SendMessageEncoder commandId(final long value)
    {
    ...
    {
        SendMessageDecoder writer = new SendMessageDecoder();
