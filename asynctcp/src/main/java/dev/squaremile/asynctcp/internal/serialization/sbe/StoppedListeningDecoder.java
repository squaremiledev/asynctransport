...
public class StoppedListeningDecoder
{
    ...
    private final StoppedListeningDecoder parentMessage = this;
    ...
    public StoppedListeningDecoder wrap(
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[StoppedListening](sbeTemplateId=");
