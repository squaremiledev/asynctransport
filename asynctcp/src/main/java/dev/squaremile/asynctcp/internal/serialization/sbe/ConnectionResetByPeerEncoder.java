...
public class ConnectionResetByPeerEncoder
{
    ...
    private final ConnectionResetByPeerEncoder parentMessage = this;
    ...
    public ConnectionResetByPeerEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public ConnectionResetByPeerEncoder wrapAndApplyHeader(
    ...
    public ConnectionResetByPeerEncoder port(final int value)
    {
    ...
    public ConnectionResetByPeerEncoder commandId(final long value)
    {
    ...
    public ConnectionResetByPeerEncoder connectionId(final long value)
    {
    ...
    {
        ConnectionResetByPeerDecoder writer = new ConnectionResetByPeerDecoder();
