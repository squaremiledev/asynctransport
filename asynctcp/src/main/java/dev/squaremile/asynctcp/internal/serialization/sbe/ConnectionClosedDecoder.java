...
public class ConnectionClosedDecoder
{
    ...
    private final ConnectionClosedDecoder parentMessage = this;
    ...
    public ConnectionClosedDecoder wrap(
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[ConnectionClosed](sbeTemplateId=");
