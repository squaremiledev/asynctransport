...
class MarketMakingTest
{
    ...
    void shouldExecuteQuantity()
    {
        ...
        assertThat(executionSpy.observedExecutions()).usingRecursiveComparison().isEqualTo(singletonList(execution(1, 101, Order.bid(21, 40))));
    }
    ...
    void shouldExecuteBestAskPrice()
    {
        ...
        assertThat(executionSpy.observedExecutions()).usingRecursiveComparison().isEqualTo(singletonList(execution(4, 102, Order.bid(19, 55))));
    }
    ...
    void shouldExecuteBestBidPrice()
    {
        ...
        assertThat(executionSpy.observedExecutions()).usingRecursiveComparison().isEqualTo(singletonList(execution(4, 103, Order.ask(21, 55))));
    }
}